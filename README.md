...
![Google Cloud](https://img.shields.io/badge/Vertex%20AI-Prompt%20Design-4285F4?style=flat-square&logo=googlecloud&logoColor=white)
![Generative AI](https://img.shields.io/badge/Generative%20AI-Agents-FF6F00?style=flat-square)
...
|------|-------------|--------|
| 👨‍🏫 Teaching Assistant | IIT Kanpur | Aug 2025 – Present |
| 🏗️ Engineering Intern | John Holland | May – Jul 2022 |
| 🏢 Engineering Intern | SmartKnower | May – Jun 2022 |
| 🤖 Summer Intern (AI) | E-Cell, IIT Kharagpur | May – Jul 2021 |

**John Holland** — Concrete Take Off, Subcontract Rates Comparison, Design, Programme Design & Installation, Testing and Commissioning  
**SmartKnower** — Construction planning and structural analysis  
**E-Cell IIT KGP** — Basics of Artificial Intelligence
...
![Hindi](https://img.shields.io/badge/Hindi-Native-FF9933?style=flat-square)
![English](https://img.shields.io/badge/English-C2%20Proficient-0052CC?style=flat-square)
...
A full institutional-grade trading system for Silver Futures with 5-fold walk-forward validation, two-voter ensemble signals, and MC Dropout 30-day price forecasting.

`Sharpe: 1.47` · `Max DD: -9.03%` · `Dir. Accuracy: 85.16%` · `15 bps realistic costs`

---

### 💰 [RealRich PPP — Global Wealth Analysis](https://github.com/DKS-MANAGER/realrich_PPP)
> Python · Plotly · Streamlit · Jupyter

Ranks the world's top 50 billionaires by PPP-adjusted wealth, revealing how emerging-market billionaires are vastly wealthier in real terms than nominal USD rankings suggest.

`Top-50 analysis` · `Interactive Streamlit dashboard` · `World Bank PPP factors`

---

### 📱 [CallBreak — Local WiFi Card Game](https://github.com/DKS-MANAGER/callbreak)
> Python · Kivy · Android · WiFi Networking

A full-featured Call Break card game for Android supporting 2–12 players over local WiFi using a 6-digit game-code system. Server-authoritative, real-time multiplayer.

`2–12 players` · `WiFi LAN` · `Kivy/Buildozer APK` · `No internet required`
